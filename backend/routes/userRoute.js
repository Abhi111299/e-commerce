...
const { registerUser, loginUser, logout, getUserData, forgotPassword, resetPassword, updatePassword, updateProfile, getAllUsers, getSingleUserById, updateUserRole } = require('../controllers/userController');
